...
router.get('/', async (req, res) => {
    ...
    // console.log(`[Employees] Fetch started at ${new Date().toISOString()}\n`);
    try {
        ...
        // Members with memberId starting with 'L-' are leads.
        // 1.1 Compute Leads Count for Field Visitors using DB-side aggregation
        // Optimized: Only match L- prefix and group by FV.
        // If fieldVisitorId is a string in some docs, this handle it better.
        ...
        ]).hint({ memberId: 1 }); // Force index usage if exists
